(function ($) {
  ...
  $(function () {
    $("#nde_contact").validator();
    $("#nde_contact").on("submit", function (e) {
      e.preventDefault();
      console.log(e);
      ...
      if(proceed){
        $.post("php/contact_ajax.php",{
          ...
          if (messageAlert && messageText) {
            var alertBox ='<div class="alert ' + messageAlert + ' alert-dismissable text-center">' + messageText + '</div>';
            $("#nde_contact").find(".messages").html(alertBox);
            $("#nde_contact")[0].reset();
          }
        });
      }
